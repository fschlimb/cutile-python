...
can be passed to :func:`cuda.tile._backend.xelaunch.xelaunch` without producing
a host-side launcher or shared library.
...
def xeas(
    ...
    *,
    ...
    (``mgpuModuleLoad``). :func:`cuda.tile._backend.xelaunch.xelaunch` launches
    the kernel directly from it.
