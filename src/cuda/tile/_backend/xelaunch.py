...
#
# Vendored from the Lighthouse project
# (lighthouse/execution/xegpu/xelaunch.py).
...
the helpers in :mod:`cuda.tile._backend.level_zero_ctypes`. The caller provides
the kernel name and launch grid/block.

Use :func:`xelaunch` to launch synchronously against host buffers:

    from cuda.tile._backend.xelaunch import xelaunch
